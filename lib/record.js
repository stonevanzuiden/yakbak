...
var render = function(template) {
  return ejs.compile(fs.readFileSync(template, 'utf8'));
}
...
module.exports = function (req, res, filename, template) {
  return buffer(res).then(function (body) {
    var bodyEncoding = isBodyHumanReadable(res) ? 'utf-8' : 'base64';
    return render(template)({ req: req, res: res, body: body, bodyEncoding: bodyEncoding });
  }).then(function (data) {
